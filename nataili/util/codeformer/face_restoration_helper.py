"""
Modified from CodeFormer's FaceRestoreHelper.
Allows cache dir to be specified.
Uses modified init_detection_model and init_parsing_model.
"""
import os
...
import numpy as np
import torch
from codeformer.facelib.utils.misc import bgr2gray, img2tensor, imwrite, is_gray
